...
public class NeostoxUTILITYCLASS {
	...
	{
		File myFile = new File("C:\\Users\\Desktop\\Desktop\\rj.xls");
	...
	public static void scrollIntoViewMethod(WebDriver driver, WebElement element) {
		JavascriptExecutor scriptExecutor = (JavascriptExecutor) driver;
		scriptExecutor.executeAsyncScript("arguments[0].scrollIntoView()", element);
	}

	public static void waitTime1(WebDriver driver, long waitseconds)

	{
		driver.manage().timeouts().implicitlyWait(Duration.ofMillis(waitseconds));
	}
}